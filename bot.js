...
const token = "Njc1NTIzNDIxMTczNzEwODY4.Xj4YTg.MRemP7DRnuzUiysirM742ZN3Q-8";
...
client.on('message', async msg => {
    ...
    .setTitle(':warning: | İlk olarak sesli bir kanala giriş yapmanız gerek.'));
      ...
      .setTitle(`**✅ | Oynatma Listesi: **${playlist.title}** Kuyruğa Eklendi!**`)
         ...
         .setTitle(' ♖ Kavatlar ♖ | Şarkı Seçimi')
...
function play(guild, song) {
  ...
  .setTitle("** ♖ Kavatlar ♖ | 🎙 Müzik Başladı**",`https://cdn.discordapp.com/avatars/473974675194511361/6bb90de9efe9fb80081b185266bb94a6.png?size=2048`)
